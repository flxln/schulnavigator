...
- **Dialog-Audio** (`daz`, `pc-raum`): Clips unter `app/content/dialog-audio/`, Route `/api/dialog/…` — siehe [ADR-010](../dokumentation/adr/010-dialog-cutscene-gated-audio.md) und [fuer-entwickler.md](./fuer-entwickler.md)
