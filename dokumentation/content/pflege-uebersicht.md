...
**Interaktive Übersicht (HTML):** [`pflege-interaktiv.html`](./pflege-interaktiv.html) — Content-Typ wählen, gefilterte Anleitung  
**Pfadkonventionen und Slug-Liste:** [`verzeichnisstruktur.md`](./verzeichnisstruktur.md)  
...
| Ort | Regeln |
|-----|--------|
| `app/public/stations/360/{slug}.webp` | Equirectangular 2:1, max. 12 MB |
...
Vollständige Tabelle: [`verzeichnisstruktur.md`](./verzeichnisstruktur.md#kanonische-slug-liste-unveränderlich)
...
| Slugs, Zonen, Pfade | [`verzeichnisstruktur.md`](./verzeichnisstruktur.md) |
