# MPZ Studio — Spezifikation (Snapshot)

> **Upload-Paket für Claude Design** — Kopie vom 2026-06-16.  
> Kanonische Quelle: [`dokumentation/spezifikationen/mpz-studio.md`](../../spezifikationen/mpz-studio.md)  
> Für UI-Design nur v0 beachten — Master-Brief: [`00-claude-design-brief.md`](./00-claude-design-brief.md).
