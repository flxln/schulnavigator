...
**Stark empfohlen** für ein Cleanup-Redesign: Zeigt das aktuelle „Durcheinander“.
...
| `studio-station-dialog.png` | `/mpz/studio/stationen/daz?tab=dialog` |
| `studio-station-dialog-audio.png` | `…/daz?tab=dialog-audio` |
| `studio-medien-modal.png` | Sidebar „Medien hochladen“ klicken |
| `studio-dialog-audio-global.png` | `/mpz/studio/dialog-audio` |
