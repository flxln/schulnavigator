...
- Typo: Nunito
- App-Komponenten: `Gs39Button`, `Gs39Card`, `TopBar` — siehe `05-DESIGN-SYSTEM.md`
...
2. **Lösungsvorschläge** für die Probleme in `03-SCREENS-UND-PROBLEME.md` (mit Begründung)
...
6. **High-Fidelity-Mockups** — alle Screens aus `03-SCREENS-UND-PROBLEME.md` in Empty / Filled / Error
