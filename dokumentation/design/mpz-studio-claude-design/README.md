...
3. Begleit-Prompt aus [`00-claude-design-brief.md`](./00-claude-design-brief.md) (Abschnitt „Begleit-Prompt“) einfügen.
4. Qualitätsregeln: [`08-se13-ui-design-prompt.md`](./08-se13-ui-design-prompt.md).
...
| Datei | Rolle | Pflicht |
|-------|--------|---------|
| [`00-claude-design-brief.md`](./00-claude-design-brief.md) | Master-Prompt, Produkt, Scope v0 | ✅ |
...
|--------------|----------|
| `01-spezifikation-auszug.md` | `dokumentation/projektmanagement/2026-06-16-mpz-studio-spezifikation.md` |
