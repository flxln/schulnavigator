...
- **Content-Pfad:** equirectangular-Dateien nach `app/public/stations/360/{slug}.webp`; im Submodule `auftraggeber/material/stationen-360-pano/equirect/` (wie in `verzeichnisstruktur.md` vorgesehen)
