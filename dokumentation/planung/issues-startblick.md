...
| `#185` | MPZ Studio: Flat-Startpan kalibrieren & persistieren | `tech` | #154 | — |
...
| #185 | https://github.com/flxln/schulnavigator/issues/185 |
...
## #185 — MPZ Studio: Flat-Startpan

**Ziel:** Aktuellen horizontalen Ausschnitt aus der Kalibrier-UI in `stations.json` schreiben (ADR-022/024).
