...
**Letzter dokumentierter Abgleich:** 2026-06-24 — Coach `layout.mascotSize`: CSS-Deckel entfernt (Nachzug zu #192); Doku [`coach-layout.md`](../ideen/archiv/coach-layout.md).
