...
## Schüler-Medien Deploy-Trennung (ADR-027)

**Fällig:** 31.10.2026 · **Status:** abgeschlossen (2026-06-24) · **GitHub-Milestone:** [#14](https://github.com/flxln/schulnavigator/milestone/14)  
**Beschreibung:** Code und Konfiguration über GitHub + Coolify; Schüler-Medien (Fotos, Videos, Dialog-/Coach-Audio) nur vom MPZ-Rechner per rsync auf den IONOS-VPS — DSGVO-konforme Trennung. Epic [#226](https://github.com/flxln/schulnavigator/issues/226), Unterissues #227–#231 (+ separates #232 History-Bereinigung) — [epic-schuelermedien-deploy-trennung.md](./epic-schuelermedien-deploy-trennung.md). **Voraussetzung:** DSB/Schule-Freigabe (#227). **Nicht:** Directus, Auto-Deploy bei Studio-Save.
