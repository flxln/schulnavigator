...
**Letzter Abgleich:** 2026-06-23 — #206 A1 Studio Tokens erledigt; Epic **#205** v3 Visual Polish — nächstes [#207](https://github.com/flxln/schulnavigator/issues/207) Shell.
...
| Issue | Thema | Hinweis |
|-------|--------|---------|
| Epic [#205](https://github.com/flxln/schulnavigator/issues/205) | MPZ Studio v3 Visual Polish | #207–#220; [epic-mpz-studio-v3-visual-polish.md](./epic-mpz-studio-v3-visual-polish.md); nächstes: [#207](https://github.com/flxln/schulnavigator/issues/207) A2 Shell (`blocker` #206 ✅) |
