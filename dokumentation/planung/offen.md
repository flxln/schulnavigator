...
**Letzter Abgleich:** 2026-06-23 — MPZ Studio UI-Cleanup Epic #195; #197–#203 erledigt (#203 Mobile Sidebar); nächstes: [#204](https://github.com/flxln/schulnavigator/issues/204) Abnahme & Doku.
...
| Issue | Thema | Hinweis |
|-------|--------|---------|
| Epic [#195](https://github.com/flxln/schulnavigator/issues/195) | MPZ Studio UI-Cleanup | #196–#204; [epic-mpz-studio-ui-cleanup.md](./epic-mpz-studio-ui-cleanup.md); nächstes: [#204](https://github.com/flxln/schulnavigator/issues/204) Abnahme & Doku |
