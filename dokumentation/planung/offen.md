...
**Letzter Abgleich:** 2026-06-24 — Phase 3 Schüler-Medien (#230 Deploy-Automatisierung auf `kunde/39-gs`); **nächstes:** [#231](https://github.com/flxln/schulnavigator/issues/231), Prod-Smoke Epic [#226](https://github.com/flxln/schulnavigator/issues/226).
...
| Issue | Thema | Hinweis |
|-------|--------|---------|
| Epic [#226](https://github.com/flxln/schulnavigator/issues/226) | Schüler-Medien Deploy-Trennung | #231, #232; [#227](https://github.com/flxln/schulnavigator/issues/227)–[#230](https://github.com/flxln/schulnavigator/issues/230) ✅; Prod-Smoke Epic offen; [epic-schuelermedien-deploy-trennung.md](./epic-schuelermedien-deploy-trennung.md); **nächstes:** [#231](https://github.com/flxln/schulnavigator/issues/231) |
