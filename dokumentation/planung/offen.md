...
**Letzter Abgleich:** 2026-06-20 — #189 Thumbnail-/Poster-Upload erledigt (Post-Mortem grün; Branch `mpz-studio-v2.1`). Offen: #190 Epic-Abschluss v2.1.
...
| Issue | Thema | Hinweis |
|-------|--------|---------|
| Epic [#186](https://github.com/flxln/schulnavigator/issues/186) | MPZ Studio v2.1 — Medien-Datei ersetzen | #187–#190; [epic-mpz-studio-v2.1.md](./epic-mpz-studio-v2.1.md) |
