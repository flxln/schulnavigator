...
**Letzter Abgleich:** 2026-07-05 — Backup T5 [#243](https://github.com/flxln/schulnavigator/issues/243): Entscheidung NAS + Headscale + rsync — [backup-t5-nas-headscale.md](./backup-t5-nas-headscale.md).
