...
**Letzter Abgleich:** 2026-06-23 — #207 A2 Shell erledigt (Post-Mortem [207](../reviews/post-mortem/post-mortem-207-2026-06-23.md)); Epic **#205** — nächstes Pilot [#209](https://github.com/flxln/schulnavigator/issues/209) Stationen-Grid (parallel [#208](https://github.com/flxln/schulnavigator/issues/208) Dashboard).
...
| Issue | Thema | Hinweis |
|-------|--------|---------|
| Epic [#205](https://github.com/flxln/schulnavigator/issues/205) | MPZ Studio v3 Visual Polish | #208–#220; [epic-mpz-studio-v3-visual-polish.md](./epic-mpz-studio-v3-visual-polish.md); nächstes Pilot: [#209](https://github.com/flxln/schulnavigator/issues/209) Stationen-Grid (`blocker` #207 ✅) |
