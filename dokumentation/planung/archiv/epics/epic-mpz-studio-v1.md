...
**Status:** abgeschlossen (2026-06-18) · Merge nach `main` via [PR #169](https://github.com/flxln/schulnavigator/pull/169)
...
| S7 Hotspots | `studio-stationen.jsx` | § S7; Detail: [Hotspot-Editor-Spec](../../../spezifikationen/mpz-studio-hotspot-editor.md) |
...
- **Hotspot-API:** `POST`/`PATCH`/`DELETE` unter `/api/mpz/stations/[slug]/hotspots` — einheitliches Fehler-Mapping (#168).
...
- [x] Hotspot bearbeiten (#167) — Post-Mortem: [post-mortem-167-2026-06-18.md](../reviews/post-mortem/post-mortem-167-2026-06-18.md)
- [x] DELETE Hotspot Fehler-Mapping (#168) — Post-Mortem: [post-mortem-168-2026-06-18.md](../reviews/post-mortem/post-mortem-168-2026-06-18.md)
- [x] Dialog-Audio-Tab (#163) — Post-Mortem: [post-mortem-163-2026-06-18.md](../reviews/post-mortem/post-mortem-163-2026-06-18.md)
- [x] Tests + `npm run build` (#159)
- [x] Doku (`fuer-entwickler.md`, Spec-Notiz, `lokal-testen-und-anschauen.md`) (#164)
- [x] Merge `mpz-studio-v1` → `main` ([PR #169](https://github.com/flxln/schulnavigator/pull/169))
