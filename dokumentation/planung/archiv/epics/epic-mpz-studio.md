...
- Spec + v0-DoD: [mpz-studio.md](../../../spezifikationen/mpz-studio.md)
...
- [x] Claude Design v0 (SE 13) — Prototyp in `dokumentation/archiv/design/mpz-studio-claude-design/version_1/mpz-studio-prototype/` (2026-06-16)
