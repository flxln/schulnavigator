...
**Stand:** 2026-06-20  
**Status:** ✅ umgesetzt — siehe [ADR-018](../../adr/018-360-sphere-viewer.md). Diese Datei ist Archiv-Kontext.  
**Bezug:** [ADR-006](../../adr/006-raum-viewer-gyro-hotspots.md) (Gyro-Viewer MVP) · Issue [#50](../../planung/archiv/issues-phase-5.md) (Wunschliste Post-Fest) · [`projektplan.md`](../../archiv/projektplan.md) (Langfrist 2027+)
...
- Kein WebXR / Kamera-AR (bleibt separates Post-Fest-Thema, [#50](../../planung/archiv/issues-phase-5.md))
...
5. **Qualität vs. Dateigröße:** Zielgröße pro Raum (z. B. max. 2–4 MB WebP nach Export)? WLAN am Fest ([`projektplan.md`](../../archiv/projektplan.md) Risiko WLAN)?
...
Issue **#50** ([`issues-phase-5.md`](../../planung/archiv/issues-phase-5.md)): Checkbox „360°-Panorama-Viewer“ nach Epic-Anlage abhaken oder durch Epic ersetzen.
...
- Wunschliste: [`issues-phase-5.md`](../../planung/archiv/issues-phase-5.md) **#50**
