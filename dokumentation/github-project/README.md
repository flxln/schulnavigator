...
- [x] Epic **#144** (MPZ Studio v0, ADR-022) — #145–#151 erledigt; #150, #153 offen; [epic-mpz-studio.md](epic-mpz-studio.md)
- [ ] **#152–#154** Startblick/Startpan (ADR-023/024) — [issues-startblick.md](issues-startblick.md)

Letzter dokumentierter Abgleich: **2026-06-17** (#151 Dashboard + Stationen-Grid; #150, #153 offen).
