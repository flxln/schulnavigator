...
**Fällig:** 31.07.2026
**Beschreibung:** Post-Fest-Erweiterung: Station-Detail unter `/mpz/studio/stationen/[slug]` mit Tabs Stammdaten, Medien, Hotspots, Dialog-Audio. Epic [#158](https://github.com/flxln/schulnavigator/issues/158), Unterissues #159–#164, #165–#168 — [epic-mpz-studio-v1.md](./epic-mpz-studio-v1.md). Branch `mpz-studio-v1`.
