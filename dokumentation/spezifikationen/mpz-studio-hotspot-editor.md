...
| DELETE-Fehler-Mapping inkonsistent zu POST/PATCH | Erledigt [#168](https://github.com/flxln/schulnavigator/issues/168): DELETE nutzt `mapHotspotError` wie PATCH — Post-Mortem [post-mortem-168-2026-06-18.md](../reviews/post-mortem/post-mortem-168-2026-06-18.md) |
